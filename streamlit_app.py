        ...
        with st.spinner("Loading data and computing signals..."):
            try:
                ...
                with st.sidebar:
                    ...
                    st.markdown(f"""
                    <div style="font-family: 'Monaco', 'Courier New', monospace; font-size: 0.9rem; white-space: pre; line-height: 1.4; margin: -1rem 0;">
                ...
                # of Trades          {num_trades:6d}
                    ...
                    st.markdown(f"""
                    <div style="font-family: 'Monaco', 'Courier New', monospace; font-size: 0.9rem; white-space: pre; line-height: 1.4; margin-top: -1rem;">
